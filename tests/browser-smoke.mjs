...
async function mobileSmoke(){
 ...
 await activate(page.locator('#worlds .worldCard').first());await page.waitForSelector('#worldModal.open');await page.waitForTimeout(250);
...
console.log(`${browserName} browser smoke passed: full-screen direct gameplay, horizontal level rail, redesigned desktop/mobile runtime, paywall, themes, music and Parent Area.`);
