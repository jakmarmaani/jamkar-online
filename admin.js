...
$('#adminMagic').onclick=()=>sendMagic().catch(e=>$('#gateStatus').textContent=e.message);$('#retry').onclick=()=>load().catch(e=>$('#gateStatus').textContent=e.message);$('#refresh').onclick=()=>load().catch(console.error);
